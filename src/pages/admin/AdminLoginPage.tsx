...
export function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // IMPORTANT: don't use .single() here.
      // PostgREST returns 406 (PGRST116) when 0 rows are returned for a singular response.
      // We want a clean "not authorized" flow without noisy 406 errors.
